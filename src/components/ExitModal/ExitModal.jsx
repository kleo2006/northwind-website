...
export default function ExitModal() {
  ...
  useEffect(() => {
    // Dev only: always allow modal to show again
    sessionStorage.removeItem("nw-exit-modal");
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("/api/exit-audit-lead", {
        method: "POST",
      ...
      >
        ...
        {submitted ? (
          ...
          <>
            ...
            <h2 className="em-title">Wait! Get a Free IT Audit Before You Go</h2>
            ...
            <div className="em-proof">
              <div className="em-proof-top">
                <div className="em-proof-left">
                  <div className="em-proof-avatars">
                    {["JH", "SO", "MB", "CS"].map((i) => (
                      <div key={i} className="em-proof-avatar">
                        {i}
                      </div>
                    ))}
                  </div>
            ...
            {errorMsg ? <p className="em-error">{errorMsg}</p> : null}
            ...
            <button
              ...
              type="button"
            >
              {isSubmitting ? "Submitting..." : "Claim My Free IT Audit"}
            </button>
